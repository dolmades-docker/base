...
RUN apt-get update && apt-get -y install wget less vim software-properties-common python3-software-properties apt-transport-https winbind p7zip-full x11-xserver-utils wmctrl xvfb language-pack-en-base && apt-get clean && rm -rf /var/lib/apt/lists/*
